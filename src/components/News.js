...
export class News extends Component {
  ...
  {
    console.log("cdm");
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=a292951ef1a94cdd871951fbd23bc74d&page=1&pageSize=${this.props.pageSize}`;
  ...
  handleNextClick = async()=>{
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=a292951ef1a94cdd871951fbd23bc74d&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`;
  ...
  render() {
    return (
      <div className='container my-3'>
        <h1 className="text-center">KhabarApp - Top Headlines</h1>
